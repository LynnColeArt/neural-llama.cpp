...
* Do not use the RPC backend, [rpc-server](https://github.com/ggml-org/llama.cpp/tree/main/tools/rpc) and [llama-server](https://github.com/ggml-org/llama.cpp/tree/main/tools/server) functionality (see https://github.com/ggml-org/llama.cpp/pull/13061).
