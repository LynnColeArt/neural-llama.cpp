...
- Optionally update [ci/run.sh](https://github.com/ggml-org/llama.cpp/blob/main/ci/run.sh) to build and run on the target platform by gating the implementation with a `GG_BUILD_...` env
